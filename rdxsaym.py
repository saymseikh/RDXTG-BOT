...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "5943258848:AAHZhU85fvLCahToyx3o5inLYdUUAwW6IJs"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'RdxChatGPT-Bot'
username = 'rdxchatgpt_bot'
